...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 bottle.py train --dataset=path/to/dataset --weights=coco

    # Resume training a model that you had trained earlier
    python3 bottle.py train --dataset=/path/to/dataset --weights=last

    # Train a new model starting from ImageNet weights
    python3 bottle.py train --dataset=/path/to/dataset --weights=imagenet
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        # Load annotations
        # COCO format saves each images in the form:
        # {[
        # info:[],
        # images:{['id':0,
        #           'width': 1537,
        ...
        #                               567.0, 1175.0, 549.0, 1127.0, 538.0, 
        #                               1089.0, 519.0, 1043.0, 517.0, 1005.0, 
        #                               523.0, 964.0, 529.0, 945.0, 520.0, 896.0, 
        #                               525.0, 862.0, 536.0, 821.0, 554.0, 769.0, 
        #                               577.0, 727.0]]
        #               'area':73894.0,
        #               'bbox':[517.0, 127.0, 447.0, 1322.0],
        #               'iscrowd':0}
        # licenses:[],
        # categories:{'supercategory':'bottle', 'category_id':1, 'name':'bottle}
        # ]}
        #
